...
with GLADE.Semaphores.Tracing; use GLADE.Semaphores, GLADE.Semaphores.Tracing;

package Tracing_Test is

   pragma Remote_Call_Interface;
   function Semaphore_String (Semaphore : Semaphore_Access) return String;
   procedure Tracing_Callback (Actor     : in Semaphore_Access;
                               Operation : in Operation_Type;
                               Data      : in Semaphore_Access);
   procedure Tracing_Report   (Message   : String);

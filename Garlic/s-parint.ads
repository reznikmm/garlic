...
package System.Partition_Interface is
   ...
   --
   --  RMM: This is called by ellaboration code (generated by compiler with
   --  option -gnatzr in command line) of each RCI package
   ...
   type RCI_Subprogram_Information is record
      Addr  : System.Address;
      --  Local address of the proxy object
   end record;
   type RCI_Subprogram_Information_Array is array (Integer range <>) of
     aliased RCI_Subprogram_Information;

   subtype RCI_Subp_Info is RCI_Subprogram_Information;
   subtype RCI_Subp_Info_Array is RCI_Subprogram_Information_Array;

   procedure Run (Main : Main_Subprogram_Type := null);
   --  Run the main subprogram

   procedure Initialize (Context : access Garlic.Contexts.Context'Class);
   --  RMM: I added this to trigger System.RPC.Establish_RPC_Receiver call

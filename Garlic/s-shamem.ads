...
package System.Shared_Memory is
   ...
   function Shared_Mem_RFile (Var : String) return SIO.Stream_Access;
   ...
   function Shared_Mem_WFile (Var : String) return SIO.Stream_Access;
   ...
   procedure Shared_Mem_Lock (Var : String);
   ...
   procedure Shared_Mem_Unlock (Var : String);
